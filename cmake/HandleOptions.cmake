...
if (USE_SANITIZER)
  ...
  if (USE_SANITIZER STREQUAL "Address")
    message(STATUS "Using Address Sanitizer, expect slower runtime.")
  ...
  elseif (USE_SANITIZER STREQUAL "Undefined")
    message(STATUS "Using Undefined Behavior Sanitizer, expect slower runtime.")
  ...
  elseif (USE_SANITIZER STREQUAL "Address;Undefined" OR
    ...
    message(STATUS "Using Address Sanitizer and Undefined Behavior Sanitizer, expect slower runtime.")
    add_compiler_linker_flag(REQUIRED "FSANITIZE_ADDRESS" "-fsanitize=address")
    add_compiler_linker_flag(REQUIRED "FSANITIZE_UNDEFINED" "-fsanitize=undefined")
    add_compiler_linker_flag(REQUIRED "FNO_SANITIZE_VPTR" "-fno-sanitize=vptr")
  elseif (USE_SANITIZER MATCHES "Memory(WithOrigins)?")
    message(STATUS "Using Memory Sanitizer, expect slower runtime.")
  ...
  elseif (USE_SANITIZER STREQUAL "Thread")
    message(STATUS "Using Thread Sanitizer, expect slower runtime.")
    add_compiler_linker_flag(REQUIRED "FSANITIZE_THREAD" "-fsanitize=thread")
  elseif (USE_SANITIZER STREQUAL "Leak")
    message(STATUS "Using Leak Sanitizer, expect slower runtime.")
